...
public:
  ...
  DenseQpIpmSolver(const DenseQp& dense_qp, 
                  const DenseQpIpmSolverSettings& solver_settings=DenseQpIpmSolverSettings());

  ///
  /// @brief Constructor.
  /// @param[in] solver_settings Solver settings.
  ///
  DenseQpIpmSolver(const DenseQpIpmSolverSettings& solver_settings=DenseQpIpmSolverSettings());
