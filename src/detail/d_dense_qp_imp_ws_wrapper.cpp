...
d_dense_qp_ipm_ws_wrapper::d_dense_qp_ipm_ws_wrapper(const std::shared_ptr<d_dense_qp_dim_wrapper>& dim, 
...
d_dense_qp_ipm_ws_wrapper::d_dense_qp_ipm_ws_wrapper(d_dense_qp_ipm_ws_wrapper&& other) noexcept 
...
d_dense_qp_ipm_ws_wrapper& d_dense_qp_ipm_ws_wrapper::operator=(d_dense_qp_ipm_ws_wrapper&& other) noexcept {
...
d_dense_qp_ipm_ws* d_dense_qp_ipm_ws_wrapper::get() { 
  if (memory_ == nullptr) {
    throw std::runtime_error("[d_dense_qp_ipm_ws_wrapper] hpipm memory is not created. Call resize() first.");
  }
...
void d_dense_qp_ipm_ws_wrapper::resize(const std::shared_ptr<d_dense_qp_dim_wrapper>& dim,
                                      const std::shared_ptr<d_dense_qp_ipm_arg_wrapper>& ipm_arg) {
  dim_ = dim;
  ipm_arg_ = ipm_arg;
  const hpipm_size_t new_memsize = d_dense_qp_ipm_ws_memsize(dim_->get(), ipm_arg_->get());
  ...
  d_dense_qp_ipm_ws_create(dim_->get(), ipm_arg_->get(), &dense_qp_ipm_ws_hpipm_, memory_);
}
